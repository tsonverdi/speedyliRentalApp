...
const PaymentForm = ({ setActiveScreen, reservationState }) => {
    ...
    const validationSchema = Yup.object({
        ...
        cvc: Yup.number().typeError("Must be number.").required("Please enter your cvc."),
        ...
        <View style={styles.container}>
            ...
            <Card>
                <Card.Content style={styles.priceCard}>
                    ...
                    <Title style={{ fontWeight: "bold" }}>${reservationState.price}</Title>
                </Card.Content>
            </Card>
            ...
            <TextInput
                ...
                render={(props) => <MaskedTextInput {...props} mask='9999 9999 9999 9999' />}
            />
            ...
            <Button mode='contained' style={styles.submitButton} onPress={formik.handleSubmit}>
                Checkout
            </Button>
