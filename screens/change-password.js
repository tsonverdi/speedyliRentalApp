...
const ChangePasswordScreen = () => {
  ...
  const validationSchema = Yup.object({
    ...
    confirmNewPassword: Yup.string().required("Please re-enter your new password.")
  ...
  const onSubmit = async (values, { resetForm }) => {
    try {
      ...
      Toast.show({
        type: "success",
        text1: "Your password updated successfully."
      });
    }
    catch (error) {
      setLoading(false);
    ...
    <ScrollView style={styles.container}>
      ...
      <TextInput
        ...
        right={<TextInput.Icon
          ...
          onPress={() => { setIsCurrentPassSecure(!isCurrentPassSecure) }}
        />}
      />
      ...
      <TextInput
        ...
        right={<TextInput.Icon
          ...
          onPress={() => { setIsNewPassRetrySecure(!isNewPassRetrySecure) }}
        />}
      />
