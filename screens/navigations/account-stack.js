        ...
        <Stack.Navigator
            ...
            {myUser ? (
                <Stack.Group>
                    ...
                    <Stack.Screen name="change-password" component={ChangePasswordScreen} options={{ title: "Change Password" }} />
                    <Stack.Screen name="reservations" component={ReservationsScreen} options={{ title: "Reservations" }} />
                    <Stack.Screen name="reservation-details" component={ReservationDetailsScreen} options={{ title: "Reservation Details" }} />
                </Stack.Group>
            ) :
                <Stack.Group>
